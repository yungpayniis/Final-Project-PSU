...
echo "<meta http-equiv='refresh' content='0; url=index.html'>";
	...
	if($years != "2557")
	{
		...
		echo "<script language='javascript'> alert('สำหรับผู้ที่มีโครงสร้างหลักสูตร 2557 เท่านั้น'); </script>";
...
if($_POST["1100"]!= 'x'){
	...
	$strSQL = "SELECT subject_ct_id FROM credit_transfer_std57 WHERE subject_ct_id_std = '".$_POST["1100"]."' and std_id = '".$_SESSION['std_id']."'  ";
...
echo "<meta http-equiv='refresh' content='0; url=user_page.php'>";
	...
	$sql = "INSERT INTO credit_transfer_std57 (subject_ct_id_std,subject_ct_id,std_id,year) 
		VALUES ('".$_POST["1100"]."','".$_POST["1100"]."','".$_SESSION['std_id']."','2557')";
...
if($_POST["1200"]!= 'x'){
	...
	$strSQL = "SELECT subject_ct_id FROM credit_transfer_std57 WHERE subject_ct_id_std = '".$_POST["1200"]."' and std_id = '".$_SESSION['std_id']."'  ";
...
echo "<meta http-equiv='refresh' content='0; url=user_page.php'>";
	...
	$sql = "INSERT INTO credit_transfer_std57 (subject_ct_id_std,subject_ct_id,std_id,year) 
		VALUES ('".$_POST["1200"]."','".$_POST["1200"]."','".$_SESSION['std_id']."','2557')";
...
if($_POST["1300"]!= 'x'){
	...
	$strSQL = "SELECT subject_ct_id FROM credit_transfer_std57 WHERE subject_ct_id_std = '".$_POST["1300"]."' and std_id = '".$_SESSION['std_id']."'  ";
...
echo "<meta http-equiv='refresh' content='0; url=user_page.php'>";
	...
	$sql = "INSERT INTO credit_transfer_std57 (subject_ct_id_std,subject_ct_id,std_id,year) 
		VALUES ('".$_POST["1300"]."','".$_POST["1300"]."','".$_SESSION['std_id']."','2557')";
...
if($_POST["1600"]!= 'x'){
	...
	$strSQL = "SELECT subject_ct_id FROM credit_transfer_std57 WHERE subject_ct_id_std = '".$_POST["1600"]."' and std_id = '".$_SESSION['std_id']."'  ";
...
echo "<meta http-equiv='refresh' content='0; url=user_page.php'>";
	...
	$sql = "INSERT INTO credit_transfer_std57 (subject_ct_id_std,subject_ct_id,std_id,year) 
		VALUES ('".$_POST["1600"]."','".$_POST["1600"]."','".$_SESSION['std_id']."','2557')";
...
if($_POST["1400"] != 'x'){
	...
	$strSQL = "SELECT subject_ct_id FROM credit_transfer_std57 WHERE subject_ct_id_std = '".$_POST["1400"]."' and std_id = '".$_SESSION['std_id']."'  ";
...
echo "<meta http-equiv='refresh' content='0; url=user_page.php'>";
	...
	$sql = "INSERT INTO credit_transfer_std57 (subject_ct_id_std,subject_ct_id,std_id,year) 
		VALUES ('".$_POST["1400"]."','".$_POST["1400"]."','".$_SESSION['std_id']."','2557')";
...
if($_POST["1500"] != 'x'){
	...
	$strSQL = "SELECT subject_ct_id FROM credit_transfer_std57 WHERE subject_ct_id_std = '".$_POST["1500"]."' and std_id = '".$_SESSION['std_id']."'  ";
...
echo "<meta http-equiv='refresh' content='0; url=user_page.php'>";
	...
	$sql = "INSERT INTO credit_transfer_std57 (subject_ct_id_std,subject_ct_id,std_id,year) 
		VALUES ('".$_POST["1500"]."','".$_POST["1500"]."','".$_SESSION['std_id']."','2557')";
