...
*/
  ...
  $sql3 = "SELECT g21,g22 FROM structerit_g ";
...
if($std_years == '2557'){
    ...
    $rsnotsubj1 = mysqli_query($objCon,$sql4);
    $rsnotsubj2 = mysqli_query($objCon,$sql4);
  
         $rs1 = mysqli_query($objCon,$sql2);
         $rs2 = mysqli_query($objCon,$sql2);
...
$outp.='<tr><td colspan="7" align="center" style="background-image: linear-gradient(-90deg, #EAEAEA, #F2F2F2,#DBDBDB,#EAEAEA);" class="font-white"><font color="black">หน่วยกิต : '.$credit.'/'.$cdtotal.'</font><br></td></tr></tfoot>';}
...
$outp.='<tr><td colspan="7" align="center" style="background-image: linear-gradient(-90deg, #EAEAEA, #F2F2F2,#DBDBDB,#EAEAEA);" class="font-white"><font color="black">หน่วยกิต : '.$credit.'/'.$g22.'</font><br></td></tr></tfoot>';}
