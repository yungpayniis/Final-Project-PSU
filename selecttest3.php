...
*/
	$sql2 = "SELECT
         ...
         ORDER BY subject_student.subject_std_id ASC";
          ...
          $sql3 = "SELECT g31,g32 FROM structerit_g ";
...
$outp.='<tr><td colspan="7" align="center" style="background-image: linear-gradient(-90deg, #EAEAEA, #F2F2F2,#DBDBDB,#EAEAEA);" class="font-white"><font color="black">หน่วยกิต : '.$credit.'/'.$g32.'</font><br></td></tr></tfoot>';}
